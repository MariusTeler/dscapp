...
class AwbData
{
    public function __construct(
        ...
        public readonly ?string $rut_BVH,
        public readonly ?string $rut_BUH,
        public readonly ?string $rut_BUC,
        public readonly ?float $valoare_exp,
        public readonly ?float $valoare_asig,
        public readonly ?float $valoare_km,
        public readonly ?float $valoare_g,
    ...
    public static function fromUiArray(array $data, int $expeditor_cc = 0): self
    {
        return new self(
            ...
            null,
            intval($data['platitor'] ?? 1),
            intval($data['platitor'] ?? null) == 2 ? intval($data['destinatar_id'] ?? 0) : intval($data['expeditor_id'] ?? 0),
            intval($data['tip_obj'] ?? null),
            intval($data['tip_obj'] ?? null) == 2 ? intval($data['piese'] ?? null) : 1,
            in_array(intval($data['tip_obj'] ?? null), [2, 3]) ? round(floatval(ToolsService::sSanitize($data['greutate'] ?? 0)), 2) : 0.5,
            in_array(intval($data['tip_obj'] ?? null), [2, 3]) ? intval($data['volum1'] ?? null) : 0,
            in_array(intval($data['tip_obj'] ?? null), [2, 3]) ? intval($data['volum2'] ?? null) : 0,
            in_array(intval($data['tip_obj'] ?? null), [2, 3]) ? intval($data['volum3'] ?? null) : 0,
            ...
            1,
            in_array(intval($data['tip_obj'] ?? null), [2, 3]) ? ToolsService::uiToVolum($data['volum1'] ?? 0, $data['volum2'] ?? 0, $data['volum3'] ?? 0) : '',
            in_array(intval($data['tip_obj'] ?? null), [2, 3]) ? ToolsService::getGreutateVolumetrica($data['volum1'] ?? 0, $data['volum2'] ?? 0, $data['volum3'] ?? 0) : 0,
            intval($data['km_preluare'] ?? null),
            intval($data['expeditor_localitate_km'] ?? null),
            intval($data['km_livrare'] ?? null),
            intval($data['destinatar_localitate_km'] ?? null),
            null,
            null,
            null,
            null,
            ...
            null,
            null,
            $data['procTva'] ?? config('tva.proc_tva_standard', 21),
            0,
            8,
            $data['borderou_id'] ?? 0,
            date('Y-m-d H:i:s'),
    ...
    public static function fromSqlArray(array $data): self
    {
        return new self(
            ...
            $data['tip_obj'] ?? null,
            $data['piese'] ?? null,
            max($data['greutate'] ?? 0, $data['greutate_vol'] ?? 0),
    ...
    public function toUiArray(): array
    {
        ...
        unset($awb_data_array['referire']);
        unset($awb_data_array['expeditor_judet_id']);
        unset($awb_data_array['expeditor_cui']);
        unset($awb_data_array['expeditor_j']);
        unset($awb_data_array['destinatar_judet_id']);
        unset($awb_data_array['destinatar_centru']);
        unset($awb_data_array['destinatar_centru_cod']);
        unset($awb_data_array['destinatar_centru_zona']);
        unset($awb_data_array['platitor_id']);
        unset($awb_data_array['tip_tarif']);
        unset($awb_data_array['mod_plata']);
        unset($awb_data_array['moneda']);
        unset($awb_data_array['volum']);
        unset($awb_data_array['greutate_vol']);
        unset($awb_data_array['km_preluare']);
        unset($awb_data_array['expeditor_localitate_km']);
        unset($awb_data_array['km_livrare']);
        unset($awb_data_array['destinatar_localitate_km']);
        unset($awb_data_array['rut_BVH']);
        unset($awb_data_array['rut_BUH']);
        unset($awb_data_array['rut_BUC']);
        unset($awb_data_array['valoare_exp']);
        unset($awb_data_array['valoare_asig']);
        unset($awb_data_array['valoare_km']);
        unset($awb_data_array['valoare_g']);
        unset($awb_data_array['valoare_fara_tva']);
        unset($awb_data_array['valoare_tva']);
        unset($awb_data_array['procTva']);
        unset($awb_data_array['anulata']);
        unset($awb_data_array['last_ckp']);
        unset($awb_data_array['src']);
        unset($awb_data_array['borderou_id']);
        unset($awb_data_array['created_by']);
        unset($awb_data_array['created_by_user']);
        unset($awb_data_array['updated_by']);
        unset($awb_data_array['updated_by_user']);
        unset($awb_data_array['printed_by']);
        unset($awb_data_array['printed_by_user']);
        unset($awb_data_array['extrainfo']);
        unset($awb_data_array['largeinfo']);
        unset($awb_data_array['folder']);
