...
class ValidateJsonAwbService
{
    ...
    public static function validate(string $json, array $pcIds, bool $withPc = false): array
    {
        ...
        $validator = Validator::make($data, AwbCreateRequest::rules($data), AwbCreateRequest::messages());
        ...
        return [
            ...
            'data' => [
                ...
                'destinatar_nume' => ToolsService::sSanitizeCleanEdgesIconvTranslate($data['destinatar'] ?? null),
                'destinatar_telefon' => ToolsService::sSanitizeCleanEdgesIconvTranslate($data['telefon'] ?? null),
                'destinatar_contact' => ToolsService::sSanitizeCleanEdgesIconvTranslate($data['contact'] ?? null),
                'destinatar_email' => ToolsService::sSanitizeCleanEdgesIconvTranslate($data['email'] ?? null),
                'destinatar_adresa' => ToolsService::sSanitizeCleanEdgesIconvTranslate($data['adresa'] ?? null),
                'destinatar_judet' => ToolsService::sSanitizeCleanEdgesIconvTranslate($data['judet'] ?? null),
                'destinatar_localitate' => ToolsService::sSanitizeCleanEdgesIconvTranslate($data['localitate'] ?? null),
                ...
                'swapped' => intval(ToolsService::sSanitizeCleanEdgesIconvTranslate($data['expInversa'] ?? '0')) == '1' ? 1 : 0,
                'observatii' => ToolsService::sSanitizeCleanEdgesIconvTranslate($data['observatii'] ?? null),
                'detalii_doc' => ToolsService::sSanitizeCleanEdgesIconvTranslate($data['detaliiDoc'] ?? null),
            ]
        ];
    }
}